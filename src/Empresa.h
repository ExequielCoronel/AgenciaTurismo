...
class Empresa
{
    ...
    public:
        ...
        void crearReserva(Fecha fechaReserva, Fecha fechaCaducidad, long codAgente, long codPaquete);
        ...
        void ingresarPaquetePropio(string destino, Fecha fechaSalida, int cantidadDias, int cantidadReservas, int cupoMaximoPasajeros, float descuento);
